...
export function Turntables() {
  ...
  return (
    <div className="page page--gray">
      <div className="category-hero category-hero--blue">
        <div className="container">
          <h1 className="category-hero-title" style={{ fontFamily: 'var(--font-heading)' }}>MÂM ĐĨA</h1>
          <p className="category-hero-desc">Khám phá bộ sưu tập mâm đĩa tiêu chuẩn. Tối ưu trải nghiệm analog.</p>
        </div>
      </div>
        ...
        <div className="catalog-layout">
          ...
          <main className="catalog-main">
            ...
            {filteredRecords.length === 0 ? (
              <div className="empty-state"><p className="page-subtitle">Chưa có sản phẩm Mâm đĩa nào được cập nhật.</p></div>
            ) : (
